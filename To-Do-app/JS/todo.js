// Following the LMS Tutorials for stringify, parse and localstorage
// var drink = '{"brand": "Monster", "type": "energy", "flavor": "zero ultra"}';

// // var JSONstring = JSON.stringify(drink);
// // document.getElementById("stringify").innerHTML = JSONstring;

// var JSONstring2 = JSON.parse(drink);
// document.getElementById("parse").innerHTML = "My favorite flavor of " + JSONstring2.brand + " " + JSONstring2.type + " is " + JSONstring2.flavor;
...
function show() {
    ...
    var html = '<ul>';
    //This displays a task tp the list in the order that it is inputted
